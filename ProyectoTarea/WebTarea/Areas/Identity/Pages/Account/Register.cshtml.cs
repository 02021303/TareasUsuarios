...
namespace WebTarea.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        return LocalRedirect("/Tareas/Index");
                    }
                }
        ...
        private UsuarioAplicacion CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(UsuarioAplicacion)}'. " +
                    $"Ensure that '{nameof(UsuarioAplicacion)}' is not an abstract class and has a parameterless constructor, or alternatively " +
